...
When the game proceeds, the animal_riddle.csv file is read and stores the data as a dictionary. The answers are the keys in the dictionary and the riddles are the values.
